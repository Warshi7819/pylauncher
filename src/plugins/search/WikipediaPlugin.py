...
class WikipediaPlugin(SearchObject.SearchObject):
    """
    The class that implements the wikipedia search plugin
    """
    ...
    def __init__(self):
        ...
        Args:
          None
        """
        # This plugin should catch searches that startswith w:
        self.searchEnabler = "w"
    ...
    def getIcon(self):
        ...
        """
        return "icons\\wikipediaIcon.ico"
    

    def executeSearch(self, searchString):
        """
        Method to fire off a search on wikipedia
        Args:
        ...
        # Build the query url
        address = "http://en.wikipedia.org/wiki/Special:Search?%s&go=Go"
        query = urlencode({"search":searchString[2:]})
